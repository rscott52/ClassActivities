...
const cities = []; // It is best practice to use const unless you know the variable will be changed later.

data.forEach(curr => cities.push(curr.address.city)); // curr.address.city this is known as dot walking to get to the object you are needing to access.
